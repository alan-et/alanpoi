...
import com.alanpoi.excel.imports.handle.RowError;
...
public class ExcelImportUtil {
    ...
    private static AbstractFileParser getFileParser() {
        AbstractFileParser fileParser = ApplicationUtil.getBean(AbstractFileParser.class);
        if (fileParser == null) {
            fileParser = SingleFactory.getExcelParser();
        }
        return fileParser;
    }
