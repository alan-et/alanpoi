...
import com.alanpoi.excel.common.ExecutorTools;
...
import com.alanpoi.excel.imports.Excel;
...
//                excelImportRes.setDownErrorUrl(downloadPath + workbookId);
                errorFile.setFile(new File(errorFile.getFilePath() + errorFile.getFileName()));
...
//        excelWorkbookManage.addFileInfo(workbookId,errorFile);
