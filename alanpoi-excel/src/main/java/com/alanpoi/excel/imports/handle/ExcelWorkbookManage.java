...
public class ExcelWorkbookManage {
    ...
    private Map<String, ErrorFile> fileMap = new ConcurrentHashMap();
    ...
    public void addFileInfo(String id, ErrorFile errorFile) {
        fileMap.put(id, errorFile);
    }

    public ErrorFile getFileInfo(String id) {
        return fileMap.get(id);
    }

    public void removeFileInfo(String id) {
        fileMap.remove(id);
    ...
    public void addErrorInfo(String workbookId, int sheetIndex, List<RowError> rowErrors) {
        ...
        if (sheetErrorList == null || sheetErrorList.isEmpty()) {
